import {
  firebase
} from "./chunk-KGMIQMPT.js";
import {
  isPlatformServer
} from "./chunk-KMM34YSF.js";
import {
  FirebaseApp,
  VERSION as VERSION2,
...
var AngularFireAuth = class _AngularFireAuth {
  ...
  constructor(options, name3, platformId, zone, schedulers, useEmulator, settings, tenantId, languageCode, useDeviceLanguage, persistence, _appCheckInstances) {
    ...
    const auth = of(void 0).pipe(observeOn(schedulers.outsideAngular), switchMap(() => zone.runOutsideAngular(() => import("./index.esm-LZCUFG7F.js"))), map(() => ɵfirebaseAppFactory(options, zone, name3)), map((app) => ɵauthFactory(app, zone, useEmulator, tenantId, languageCode, useDeviceLanguage, settings, persistence)), shareReplay({
      bufferSize: 1,
      refCount: false
    }));
...
firebase/compat/app/dist/esm/index.esm.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-LTYMMD57.js.map
